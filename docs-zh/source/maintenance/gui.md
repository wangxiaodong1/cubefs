...
## 2.10 权限管理<br>
### 2.10.1 权限管理说明<br>
#### 2.10.1.1 GUI账号与cubefs集群账号区分<br>
此处的账号仅仅是登录GUI平台使用，跟cubefs集群里通过ak、sk访问卷里面文件的账号无关<br>
#### 2.10.1.2 初始账户<br>
